...
{
public:
	bool InitalizeParticleSystem(string directory, string name);
	...
	void SetMatrices(glm::mat4* a_matProjection, glm::mat4* a_matView, glm::vec3 vEye, glm::vec3 vView, glm::vec3 vUpVector);
